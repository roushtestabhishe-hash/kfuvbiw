...
const NFT: React.FC<NFTProps> = ({ onBack }) => {
  ...
  const dummyNFTs = [
    { id: 1, name: "Kazar Champion #001", image: "/nft/breaker.png", rarity: "Legendary", price: "0.1 CAMP" },
    { id: 2, name: "Game Master #042",   image: "/nft/climb.png",   rarity: "Epic",      price: "0.1 CAMP" },
    { id: 3, name: "Victory Badge #123",  image: "/nft/finder.png",  rarity: "Rare",      price: "0.1 CAMP" },
    { id: 4, name: "Warrior Spirit #567", image: "/nft/coder.png",   rarity: "Common",    price: "0.1 CAMP" },
  ];
